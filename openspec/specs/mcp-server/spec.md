...
Creates and runs an MCP server that exposes OpenAPI operations as tools, forwarding calls to the upstream API with authentication, error wrapping, and multi-transport support.
